  ...
  return (
    <>
      ...
      <FindMain>
        ...
        <OrangeTextBox className="score600" style={{ marginTop: "40px" }}>원하는 기술 스택을 선택해주세요!</OrangeTextBox>
        <ConditionBoxCover>
        ...
        <ConditionBoxCover>
            ...
            <OrangeTextBox className="score600" style={{ marginTop: "40px" }}>원하는 기술 경험을 선택해주세요!</OrangeTextBox>
            <ConditionBoxCover>
        ...
        <OrangeTextBox className="score600" style={{ marginTop: "40px" }}>원하는 프로젝트 방식을 선택해주세요!</OrangeTextBox>
        <ConditionBoxCover>
